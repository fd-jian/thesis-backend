...
window.onload = function() {
  ...
  Object.entries(chartsById).forEach(chartsEntry => chartsEntry[1].values = initChartValues);
...
const indexToAlphaNumeric = i => 
  ((num = i + 10) > 35 ? num % 36 + 10 : num).toString(36);
